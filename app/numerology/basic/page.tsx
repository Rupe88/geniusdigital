...
import { NumerologyMoreDetails } from '@/components/numerology/NumerologyMoreDetails';
                ...
                <div className="p-6 text-center space-y-3">
                  ...
                  {mulankDetail ? (
                    <div className="pt-4 text-left space-y-3">
                      ...
                      <NumerologyMoreDetails detail={mulankDetail} />
                    </div>
                  ) : null}
                </div>
              )}
                ...
                <div className="p-6 text-center space-y-3">
                  ...
                  {bhagyankDetail ? (
                    <div className="pt-4 text-left space-y-3">
                      ...
                      <NumerologyMoreDetails detail={bhagyankDetail} />
                    </div>
                  ) : null}
                </div>
              )}
          ...
          isCalculating ? (
            ...
            <div className="divide-y divide-slate-100">
              ...
              <div className="p-6 text-left space-y-3">
                ...
                <NumerologyMoreDetails detail={nameDetail} />
              </div>
            </div>
          )
        ) : (
