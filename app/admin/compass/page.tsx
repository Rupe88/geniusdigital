...
export default function AdminCompassLeadsPage() {
  ...
  const fetchRows = useCallback(async () => {
    try {
      setLoading(true);
      const res = await leadsApi.getCompassLeads({
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-[var(--foreground)]">Compass Users</h1>
        <p className="text-[var(--muted-foreground)] mt-1">
          Submitted users from the compass app.
        </p>
      </div>
