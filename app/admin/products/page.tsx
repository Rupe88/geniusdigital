            ...
            <table className="w-full">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {Array.from({ length: 6 }).map((_, i) => (
                  <tr key={i}>
                    <td className="px-6 py-4"><div className="flex items-center gap-4"><div className="h-10 w-10 skeleton-shimmer rounded" /><div className="space-y-2"><div className="h-4 w-32 skeleton-shimmer rounded" /><div className="h-3 w-20 skeleton-shimmer rounded" /></div></div></td>
                    <td className="px-6 py-4"><div className="h-4 w-16 skeleton-shimmer rounded" /></td>
                    <td className="px-6 py-4"><div className="h-4 w-8 skeleton-shimmer rounded" /></td>
                    <td className="px-6 py-4"><div className="h-6 w-16 skeleton-shimmer rounded" /></td>
                    <td className="px-6 py-4"><div className="h-6 w-14 skeleton-shimmer rounded" /></td>
                    <td className="px-6 py-4 text-right"><div className="h-8 w-20 skeleton-shimmer rounded ml-auto" /></td>
                  </tr>
                ))}
              </tbody>
            </table>
